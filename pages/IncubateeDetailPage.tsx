        ...
        <div className="container mx-auto px-4 py-16">
            <div className="flex flex-col lg:flex-row items-center gap-12">
                <div className="lg:w-1/3 text-center">
                    ...
                    <h1 className="text-5xl lg:text-6xl font-bold mt-6">{incubatee.name}</h1>
                    <p className="text-3xl text-muted-foreground mt-2">{incubatee.tagline}</p>
                    <div className="mt-6 flex justify-center space-x-4">
                        <a href={incubatee.website} target="_blank" rel="noopener noreferrer" className="bg-primary text-primary-foreground text-xl px-8 py-4 rounded-lg hover:bg-primary/90 transition-colors">Website</a>
                ...
                <div className="lg:w-2/3">
                    <div className="bg-card border border-border p-8 rounded-xl shadow-md">
                        <h2 className="text-4xl font-semibold mb-4 border-b border-border pb-2">About {incubatee.name}</h2>
                        <p className="text-muted-foreground text-xl leading-relaxed">{incubatee.description}</p>
                        
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 text-center">
                            <div>
                                <p className="font-bold text-2xl">{incubatee.industry}</p>
                                <p className="text-lg text-muted-foreground">Industry</p>
                            </div>
                             <div>
                                <p className="font-bold text-2xl">{incubatee.foundingDate}</p>
                                <p className="text-lg text-muted-foreground">Founding Date</p>
                            </div>
                             <div>
                                <p className="font-bold text-2xl text-green-400">{incubatee.stage} Stage</p>
            ...
            <div className="mt-16">
                <h2 className="text-5xl font-bold text-center mb-8">Founders</h2>
                <div className="flex flex-wrap justify-center gap-8">
                    {incubatee.founders.map(founder => (
                        <div key={founder.name} className="bg-card border border-border p-6 rounded-xl text-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 shadow-md">
                            ...
                            <p className="text-muted-foreground text-xl">{founder.background}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="mt-16">
                <h2 className="text-5xl font-bold text-center mb-8">Key Achievements</h2>
                <div className="max-w-2xl mx-auto">
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground text-xl bg-card border border-border p-6 rounded-xl shadow-md">
